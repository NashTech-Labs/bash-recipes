...
#
# AUTHOR: Vinay
# BOOK: RandallKMitchell: Shell Scripting
#
# #
...
touch $DATAFILE          # Initialize to a null file

OUTFILE="/tmp/largefiles.out" # Output user file
touch $OUTFILE           # Initialize to a null file

HOLDFILE="/tmp/temp_hold_file.out" # Temporary storage file
touch $HOLDFILE          # Initialize to a null file
